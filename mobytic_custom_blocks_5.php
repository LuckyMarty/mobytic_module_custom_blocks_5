...
class Mobytic_custom_blocks_5 extends Module
{
    ...
    protected function renderForm()
    {
        ...
        $helper->submit_action = 'submitMobytic_custom_blocks_5Module';
    ...
    protected function getConfigFormValues()
    {
        return array(
            ...
            'MOBYTIC_CUSTOM_BLOCKS_5_ACCOUNT_EMAIL' => Configuration::get('MOBYTIC_CUSTOM_BLOCKS_5_ACCOUNT_EMAIL', 'contact@prestashop.com'),
            'MOBYTIC_CUSTOM_BLOCKS_5_ACCOUNT_PASSWORD' => Configuration::get('MOBYTIC_CUSTOM_BLOCKS_5_ACCOUNT_PASSWORD', null),
        );
    }
